...
const analyzeDanceVideoPrompt = ai.definePrompt({
  ...
  prompt: `You are an AI dance analyst and instructor, powered by the latest Gemini 1.5 Flash model. Your task is to analyze the dance video at the following URL: {{{videoUrl}}}. 
